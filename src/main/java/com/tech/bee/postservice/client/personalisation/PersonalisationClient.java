...
import com.tech.bee.postservice.configuration.client.BaseWebClient;
import com.tech.bee.postservice.configuration.personalisation.PersonalisationClientProperties;
...
public class PersonalisationClient extends BaseWebClient {
    ...
    private final PersonalisationClientProperties clientProperties;
    private final SecurityService securityService;

    @Autowired
    PersonalisationClient(final PersonalisationClientProperties personalisationClientProperties,
                          final SecurityService securityService) {
        super(personalisationClientProperties);
        this.clientProperties = personalisationClientProperties;
        this.securityService = securityService;
    }

    public List<String> fetchInterests(final String userId) {
        final String fetchPreferencesUri = clientProperties.getFetchPreferencesPath() + userId;
